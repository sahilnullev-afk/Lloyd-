...
MONGO_URI = (os.getenv("MONGO_URI") or os.getenv("MONGODB_URI") or os.getenv("MONGO_URL") or getattr(config, "MONGO_URI", None))
db = None
async_db = None
...
if MONGO_URI:
    try:
        ...
        motor_client.get_io_loop = lambda: asyncio.get_running_loop()
